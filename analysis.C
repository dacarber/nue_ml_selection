...
void analysis()
{
    ...
    */
    ...
    SpecContainer spectra("/pnfs/icarus/scratch/users/dcarber/hdf5_files/numi_nu_corsika_240606/flat_caf/*.flat.root", "spectra_new_nucosmics.root", 1.03e20, 1.03e20 );
    /**
