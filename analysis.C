...
void analysis()
{
    ...
    */
    ...
    SpecContainer spectra("/pnfs/icarus/scratch/users/dcarber/hdf5_files/numi_nu_corsika_230918/larcv_01_mlreco_ana.root", "spectra_nucosmics.root", 1.83e19, 2.6e20 );
    /**
