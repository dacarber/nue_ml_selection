...
void analysis()
{
    ...
    */
    ...
    SpecContainer spectra("/pnfs/icarus/persistent/users/lkashur/numi_nu_cosmic_v09_89_01p01/output_flat/*.flat.root", "spectra_nucosmics.root", -1, -1 ); //Collection plane only charge
